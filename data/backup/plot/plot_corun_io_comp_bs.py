...
# Fist subplot
plot_script += base_next_plot.format(title=r"(a) small I/O size: I/O-intensive task")
plot_script += """
set key noenhanced
...
# Second subplot
plot_script += base_next_plot.format(title=r"(b) large I/O size: I/O-intensive task")
plot_script += """
unset ylabel
set yrange [0:6.2]
set ytic 1.5
...
# Third subplot
plot_script += base_font.format(**font_dict)
plot_script += base_next_plot.format(title=r"(c) small I/O size: compute-intensive task")
plot_script += """
set key noenhanced
set xlabel "I/O Size"
...
# Fourth subplot
plot_script += base_next_plot.format(title=r"(d) large I/O size: compute-intensive task")
plot_script += """
unset ylabel
set yrange [0:4]
set ytic 1
