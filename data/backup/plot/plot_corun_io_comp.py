...
# For I/O-compute threads
csv_name = "data_corun_io_comp_single_core"
...
metrics += [f"{base.name}_bg" for base in baselines]
iosizes_param = Param("iosize", ["16KB", "64KB", "256KB", "1MB", "2MB"])
...
# First subplot
plot_script += base_next_plot.format(title=r"(a) multi-thread: I/O tail latency (p99.9)")
plot_script += """
...
# Second subplot
plot_script += base_next_plot.format(title=r"(b) multi-thread: compute-task utilization")
plot_script += """
set ylabel "Batch kops per second"
set yrange [0:2.4]
set ytic 0.6
"""
plot_script += f"plot \"{data_files[0]}\" \\"
...
# Third subplot
plot_script += base_next_plot.format(title=r"(c) I/O size: I/O throughput")
plot_script += """
set xlabel "I/O Size"
...
# Fourth subplot
plot_script += base_next_plot.format(title=r"(d) I/O size: compute-task utilization")
plot_script += """
